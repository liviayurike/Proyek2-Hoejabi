      ...
      <div class="container">
        ...
        <div class="portfolio-details-container">
          ...
          <div class="owl-carousel portfolio-details-carousel">
            ...
            <img src="assets/img/portfolio/1b.jpg" class="img-fluid" alt="">
            <img src="assets/img/portfolio/1c.jpg" class="img-fluid" alt="">
          </div>

          <div class="portfolio-info">
            <h3>Vanya In Purple | THE NOVELLA SCARF (Superfine Watersplash Voal Hijab Premium)</h3>
            <ul>
              <li><strong>Bahan & Ukuran</strong>: -SUPERFINE 120 X 120
                                                   -SUPERFINE 140 X 140</li>
              <li><strong>Variation</strong>: ORIGINAL , WATERSPLASH</li>
              <li><strong>Kuantitas</strong>: tersisa 386 buah</li>
              <li><strong><a href="keranjang.php">Masukkan Keranjang</strong></a></li>
              <li><strong><a href="transaksi.php">Beli</strong></a></li>
            </ul>
          </div>
