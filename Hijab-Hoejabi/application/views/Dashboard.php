...
<div class="row text-center mt-3">
  ...
  <div class="card-body">
    <h5 class="card-title mb-1"><?php echo $produk->nama_brg ?></h5>
    <small><?php echo $produk->keterangan ?></small><br>

    <span class="badge badge-pill badge-success mb-3">Rp. <?php echo number_format($produk->harga, 0,',','.')  ?></span><br>
    <?php echo anchor('Dashboard/tambah_ke_keranjang/' .$produk->id_produk, '<div class="btn btn-sm btn-primary">Tambah Keranjang</div>') ?>

    <?php echo anchor('Dashboard_akhir/detail/' .$produk->id_produk, '<div class="btn btn-sm btn-success">Detail</div>') ?>
  </div>
</div>
