  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item ">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/hijab"><!--<i class="fas fa-fw fa-film" aria-hidden="true"></i>--> Data Hijab</a>
      ...
      <li class="nav-item ">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          <!--<i class="fas fa-fw fa-film"></i>-->
          <span>Accerosies Hijab</span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/acchijab"><!--<i class="fas fa-fw fa-film" aria-hidden="true"></i>--> Data Accesories Hijab</a>
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/tambahAccHijab"><i class="fas fa-fw fa-plus" aria-hidden="true"></i>Tambah Accesories Hijab</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item ">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="<?php echo base_url(); ?>admin/pakaian"><!--<i class="fas fa-fw fa-film" aria-hidden="true"></i>--> Data Pakaian</a>
