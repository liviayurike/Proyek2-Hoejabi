    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-plus"></i> Tambah Accessories Hijab</h1><br>

          <?php form_open('admin/insert_acchijab'); ?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <table class="table table-bordered" width="70%" cellspacing="0" style="color: black">
                    ...
                    <tr>
                      <th>Deskripsi</th>
                      <td>:</td>
                      <td><textarea class="form-control" name="deskripsi" id="deskripsi"></textarea></td>
                    </tr>
                    <tr>
                      <th>Gambar </th>
                      <td>:</td>
                    ...
                    <tr>
                      <td colspan="3"><button type="submit" name="submit" class="btn btn-primary float-right">Insert</button></td>
                    </tr>
                    </tbody>
                  </table>
                </form>
