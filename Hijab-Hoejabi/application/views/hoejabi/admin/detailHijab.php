    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><!--<i class="fas fa-fw fa-film"></i>--> Hijab <?= $h['nama']; ?></h1><br>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div class="col-md-12">
                  <a class="btn text-left bg-maroon text-white" width = "15px" style="margin-bottom: 20px;" href="<?php echo base_url(); ?>admin/hijab"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a><br>
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                          <table class="table table-borderless"  style="color: black">
                            <tbody>
                              <tr>
                                <td colspan="3" class="text-center"><img src="<?= base_url().'assets/img/portfolio/'.$h['gambar']; ?>" width = 300 height = 400></i></td>
                              </tr>
                              <tr>
                                <td>Nama</td>
                                <td>:</td>
