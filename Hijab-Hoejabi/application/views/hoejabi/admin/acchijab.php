    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><!--<i class="fas fa-fw fa-film"></i>--> Accessories Hijab</h1><br>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
              <a href="<?php echo base_url(); ?>admin/tambahAccHijab"><i class="fas fa-fw fa-plus"></i>Tambah Accessories Hijab</a></h6>
            </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" style="color: black">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?= $a['deskripsi']; ?></td>
                      <td><?= $a['gambar']; ?></td>
                      <td><a class="btn btn-success" href="<?php echo base_url(); ?>admin/detailAccHijab/<?= $f['id_acchijab'];?>">Detail</a>
                          <a class="btn btn-danger" href="<?php echo base_url(); ?>admin/hapusAccHijab/<?= $f['id_acchijab'];?>"> Hapus</a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
