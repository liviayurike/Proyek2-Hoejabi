        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              ...
              <a href="<?php echo base_url(); ?>admin/tambahHijab"><i class="fas fa-fw fa-plus"></i>Tambah Hijab</a></h6>
            </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0" style="color: black">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?= $h['deskripsi']; ?></td>
                      <td><?= $h['gambar']; ?></td>
                      <td><a class="btn btn-success" href="<?php echo base_url(); ?>admin/detailHijab/<?= $f['id_hijab'];?>">Detail</a>
                          <a class="btn btn-danger" href="<?php echo base_url(); ?>admin/hapusHijab/<?= $f['id_hijab'];?>"> Hapus</a></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
