        ...
        <div class="container d-flex align-items-center">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li><a href="<?php echo base_url(); ?>hoejabi/testimonials">Testimonials</a></li>
                    <li><a href="<?php echo base_url(); ?>hoejabi/contact">Contact Us</a></li>
        ...
        <section id="what-we-do" class="what-we-do">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>What We Do</h2>
                    <p>Quran Surat Al-A'raf ayat 26:</p>
                    <p>
