                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <form role="form">
                                                ...
                                                <tr>
                                                    <th>Produk : </th>
                                                    <td> <input class="form-control" placeholder="Product"></td>
                                                </tr>
                                                <tr>
                                                <th>Qty : </th>
                                                ...
                                                <tr>
                                                    <th>Harga : </th>
                                                    <td><input type="number" class="form-control" placeholder="Harga"></td>
                                                </tr>
                                                <tr>
                                                    <th>Sub Total: </th>
                                                    <td> <input class="form-control" placeholder="Sub Total" type="number"></td>
                                                </tr>
                                                <tr>
                                                <th>Potongan: </th>
                                                    <td> <input class="form-control" placeholder="Potongan"></td>
                                                </tr>
                                        </table> 
                                                </div>
