                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <form role="form">
                                                ...
                                                <tr>
                                                <th>No Telp : </th>
                                                    <td> <input class="form-control" type="number" placeholder="No Telp"></td>
                                                    </tr>
                                                <tr>
                                                    <th>Alamat : </th>
                                                ...
                                                <tr>
                                                    <th>Produk : </th>
                                                    <td><input type="text" class="form-control" placeholder="produk"></td>
                                                </tr>
                                                <tr>
                                                    <th>Harga : </th>
                                                    <td> <input class="form-control" placeholder="Harga" type="number"></td>
                                                </tr>
                                                <tr>
                                                    <th>Total Harga : </th>
                                                    <td> <input class="form-control" placeholder="Total Harga" type="number"></td>
                                                </tr>
                                                <tr>
